...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  printf("Name: Sivamalaich Chelvan\n");
	  printf("Reg No: 212225100051\n");
	  printf("Department: CSE(CS)\n");
	  HAL_Delay(5000);
...
## Output screen shots of Serial port utility   :
 <img width="1917" height="1015" alt="Screenshot 2026-08-01 162804" src="https://github.com/user-attachments/assets/bba2e8cd-9291-4f3c-ab11-e52ac5d2e132" />
